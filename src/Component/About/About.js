  ...
  return (
    <div className="About custom-display" id="About">
      {windowWidth < 1001 ? (
        <Col>
          <Col
            className="image-container sm d-flex justify-content-center"
            style={{ padding: 0, marginBottom: 70 }}
          >
            <AboutImage />
          </Col>
          <Col style={{ padding: 0 }}>
            ...
            <p className="description-text">{props.data.desc}</p>
            <Row className="bio-sm top-bio" style={{ marginTop: 9 }}>
              ...
              <Col>
                ...
                <p>
                  ...
                  MongoDB, Bootstrap, Tailwind, Figma, Git, and Shopify.
                </p>
              </Col>
            </Row>
